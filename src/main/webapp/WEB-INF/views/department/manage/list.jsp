...
<div id="departmentManageListPanel">
	<div class="toolbar-menu-panel">
		<button class="btn btn-bg add-department-btn"><spring:message code="menu.add" /></button>
		<button class="btn btn-bg remove-departments-btn"><spring:message code="menu.delete" /></button>
	</div>
	<div class="real-content-panel">
		<table class="table table-stripe table-hover">
			<thead>
				<th class="check-all-btn cursor-pointer" width="100px"><spring:message code="menu.number" /></th>
				<th width="150px"><spring:message code="menu.code" /></th>
				<th><spring:message code="menu.departmentName" /></th>
				<th><spring:message code="menu.createTime" /></th>
				<th><spring:message code="menu.operates" /></th>
