...
<div id="roleManageListPanel">
	<div class="toolbar-menu-panel">
		<button class="btn btn-bg add-role-btn"><spring:message code="menu.add" /></button>
		<button class="btn btn-bg remove-roles-btn"><spring:message code="menu.delete" /></button>
	</div>
	<div class="real-content-panel">
		<table class="table table-stripe table-hover">
			<thead>
				...
				<th><spring:message code="menu.roleName" /></th>
