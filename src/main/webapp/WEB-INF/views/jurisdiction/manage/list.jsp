...
<div id="jurisdictionManageListPanel">
	<div class="toolbar-menu-panel">
		<button class="btn btn-bg add-jurisdiction-btn"><spring:message code="menu.add" /></button>
		<button class="btn btn-bg remove-jurisdictions-btn"><spring:message code="menu.delete" /></button>
	</div>
	<div class="real-content-panel">
		<table class="table table-stripe table-hover">
			<thead>
				<th class="check-all-btn cursor-pointer" width="100px"><spring:message code="menu.number" /></th>
				<th><spring:message code="menu.jurisdictionName" /></th>
